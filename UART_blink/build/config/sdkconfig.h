...
#define CONFIG_ESP32_DEFAULT_PTHREAD_CORE_NO_AFFINITY                          \
...
#define CONFIG_ESP32_TIME_SYSCALL_USE_RTC_FRC1                                 \
  CONFIG_NEWLIB_TIME_SYSCALL_USE_RTC_HRT
#define CONFIG_ESP32_TIME_SYSCALL_USE_RTC_HRT                                  \
  CONFIG_NEWLIB_TIME_SYSCALL_USE_RTC_HRT
...
#define CONFIG_ESP32_WIFI_SOFTAP_BEACON_MAX_LEN                                \
  CONFIG_ESP_WIFI_SOFTAP_BEACON_MAX_LEN
#define CONFIG_ESP32_WIFI_STATIC_RX_BUFFER_NUM                                 \
  CONFIG_ESP_WIFI_STATIC_RX_BUFFER_NUM
#define CONFIG_ESP32_WIFI_TASK_PINNED_TO_CORE_0                                \
...
#define CONFIG_ESP_SLEEP_DEEP_SLEEP_WAKEUP_DELAY                               \
  CONFIG_ESP_SLEEP_WAIT_FLASH_READY_EXTRA_DELAY
#define CONFIG_ESP_TASK_WDT CONFIG_ESP_TASK_WDT_INIT
#define CONFIG_FLASHMODE_DIO CONFIG_ESPTOOLPY_FLASHMODE_DIO
#define CONFIG_FOUR_UNIVERSAL_MAC_ADDRESS                                      \
...
#define CONFIG_OPTIMIZATION_ASSERTION_LEVEL                                    \
...
#define CONFIG_SEMIHOSTFS_MAX_MOUNT_POINTS                                     \
...
#define CONFIG_SUPPRESS_SELECT_DEBUG_OUTPUT                                    \
  CONFIG_VFS_SUPPRESS_SELECT_DEBUG_OUTPUT
#define CONFIG_SYSTEM_EVENT_QUEUE_SIZE CONFIG_ESP_SYSTEM_EVENT_QUEUE_SIZE
#define CONFIG_SYSTEM_EVENT_TASK_STACK_SIZE                                    \
